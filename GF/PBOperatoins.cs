...
namespace GF
{
    class PBOperatoins
    {
        ...
        public static PBNumber Rev(PBNumber a)
        {
            PBNumber power = new PBNumber("");
            var res = Pow(a, power);
            return res;
        }
    }
